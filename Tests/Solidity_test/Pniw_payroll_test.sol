...
import "pniw_payroll.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/security/ReentrancyGuard.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";

contract PNiWPayrollTest is Ownable, ReentrancyGuard {
    PNiWPayroll public payrollContract;
    ...
    constructor(address _payrollContract, address _usdcToken) {
        ...
        payrollContract = PNiWPayroll(_payrollContract);
